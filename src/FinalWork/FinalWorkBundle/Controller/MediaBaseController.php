...
use FinalWork\FinalWorkBundle\Controller\Interfaces\MediaInterface;
...
class MediaBaseController extends BaseController implements MediaInterface
{
    ...
    public function create(
        ...
        $mediaMimeType = $this->get('final_work.facade.media.mime_type')
            ->getMimeTypeByName($mimeType);
        if ($mediaMimeType === null) {
            throw new RuntimeException("MediaMimeType doesn't exist");
        }

        $mediaType = $this->get('final_work.facade.media_type')
            ->find($mediaType);
        if ($mediaType === null) {
