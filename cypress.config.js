module.exports = {
    e2e: {
        ...
        specPattern: [
            ...
            'tests/Cypress/integration/user/change-profile-image.js',
            'tests/Cypress/integration/user/delete-profile-image.js',
            ...
            'tests/Cypress/integration/event/create-event-address.js',
            'tests/Cypress/integration/event/create-event-calendar.js',
            ...
            'tests/Cypress/integration/event/delete-event-calendar.js',
            'tests/Cypress/integration/event/delete-event-address.js',
