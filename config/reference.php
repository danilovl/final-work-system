 ...
 *     batching_method?: "relay"|"apollo", // Default: "relay"
 *     definitions?: array{
 *         argument_class?: scalar|null, // Default: "Overblog\\GraphQLBundle\\Definition\\Argument"
 *         default_field_resolver?: scalar|null, // Default: "Overblog\\GraphQLBundle\\Resolver\\FieldResolver"
 *         class_namespace?: scalar|null, // Default: "Overblog\\GraphQLBundle\\__DEFINITIONS__"
 *         cache_dir?: scalar|null, // Default: null
 *         cache_dir_permissions?: scalar|null, // Default: null
 *         use_classloader_listener?: bool, // Default: true
 *         auto_compile?: scalar|null, // Default: true
 *         show_debug_info?: bool, // Show some performance stats in extensions // Default: false
 *         config_validation?: bool, // Default: true
 *         schema?: array<string, array{ // Default: []
 *             query?: scalar|null, // Default: null
 *             mutation?: scalar|null, // Default: null
 *             subscription?: scalar|null, // Default: null
 *             types?: list<scalar|null>,
 *         }>,
 *         mappings?: array{
 *             auto_discover?: array{
 *                 bundles?: bool, // Default: false
 *                 root_dir?: bool, // Default: false
 *                 built_in?: bool, // Default: true
 *             },
 *             types?: list<array{ // Default: []
 *                 types?: list<"yaml"|"graphql"|"annotation"|"attribute">,
 *                 dir?: scalar|null, // Default: null
 *                 suffix?: scalar|null, // Default: ".types"
 *             }>,
 *         },
 *         builders?: array{
 ...
 *         enabled?: bool, // Default: true
 *         internal_error_message?: scalar|null, // Default: "Internal server Error"
 *         rethrow_internal_exceptions?: bool, // Default: false
 *         debug?: bool, // Default: true
 *         log?: bool, // Default: true
 *         logger_service?: scalar|null, // Default: "logger"
 *         map_exceptions_to_parent?: bool, // Default: false
 *         exceptions?: array{
 *             warnings?: list<scalar|null>,
 *             errors?: list<scalar|null>,
 *         },
 *     },
 *     services?: array{
 *         executor?: scalar|null, // Default: "Overblog\\GraphQLBundle\\Executor\\Executor"
 *         promise_adapter?: scalar|null, // Default: "GraphQL\\Executor\\Promise\\Adapter\\SyncPromiseAdapter"
 *         expression_language?: scalar|null, // Default: "Overblog\\GraphQLBundle\\ExpressionLanguage\\ExpressionLanguage"
 *         cache_expression_language_parser?: scalar|null,
 *     },
 *     security?: array{
 *         query_max_depth?: scalar|null, // Disabled if equal to false. // Default: 0
 *         query_max_complexity?: scalar|null, // Disabled if equal to false. // Default: 0
 *         enable_introspection?: bool, // Default: true
 *         handle_cors?: bool, // Default: false
 *     },
 *     doctrine?: array{
 *         types_mapping?: list<scalar|null>,
 *     },
 *     profiler?: array{
 *         query_match?: scalar|null, // Default: null
 *     },
 * }
 ...
 *     enabled?: scalar|null, // Default: true
 *     enabledAutoAdminRefreshCache?: scalar|null, // Default: false
 *     locale?: list<scalar|null>,
 *     domain?: list<scalar|null>,
 * }
 * @psalm-type DanilovlRenderServiceConfig = array{
 *     prefix?: scalar|null, // Default: null
 *     to_snake_case?: scalar|null, // Default: true
 *     filter_options?: array{
 *         needs_environment?: scalar|null, // Default: false
 *         needs_context?: scalar|null, // Default: false
 *         is_variadic?: scalar|null, // Default: false
 *         is_safe?: list<scalar|null>,
 *         is_safe_callback?: list<scalar|null>,
 *         pre_escape?: scalar|null, // Default: null
 *         preserves_safety?: list<scalar|null>,
 *         node_class?: scalar|null, // Default: "Twig\\Node\\Expression\\FilterExpression"
 *         deprecated?: scalar|null, // Default: false
 *         alternative?: scalar|null, // Default: null
 *     },
 ...
 *         is_safe?: list<scalar|null>,
 *         is_safe_callback?: list<scalar|null>,
 *         node_class?: scalar|null, // Default: "Twig\\Node\\Expression\\FunctionExpression"
 *         deprecated?: scalar|null, // Default: false
 *         alternative?: scalar|null, // Default: null
 *     },
 * }
 * @psalm-type DanilovlPermissionMiddlewareConfig = array{
 *     kernel_controller_priority?: scalar|null, // Priority for the controller listener // Default: null
 *     kernel_response_priority?: scalar|null, // Priority for the response listener // Default: null
 * }
 * @psalm-type DanilovlDoctrineEntityDtoConfig = array{
 *     isEnableEntityDTO?: scalar|null, // Default: false
 *     isEnableEntityRuntimeNameDTO?: scalar|null, // Default: false
 *     isAsEntityDTO?: scalar|null, // Default: false
 *     entityDTO?: list<scalar|null>,
 *     isEnableScalarDTO?: scalar|null, // Default: false
 *     isAsScalarDTO?: scalar|null, // Default: false
 *     scalarDTO?: list<scalar|null>,
 * }
 * @psalm-type DanilovlSelectAutocompleterConfig = array{
 *     default_option?: array{
 *         id_property?: scalar|null, // Default: "id"
 *         property?: scalar|null, // Default: "name"
 *         property_search_type?: scalar|null, // Default: "any"
 *         image?: scalar|null, // Default: null
 *         image_result_width?: scalar|null, // Default: "100px"
 *         image_selection_width?: scalar|null, // Default: "18px"
 *         root_alias?: scalar|null, // Default: "e"
 *         limit?: scalar|null, // Default: 10
 *         widget?: scalar|null, // Default: "select2_v4"
 *         manager?: scalar|null, // Default: null
 *         base_template?: scalar|null, // Default: "@SelectAutocompleter/Form/versions.html.twig"
 *         order_by?: list<scalar|null>,
 *         where?: list<scalar|null>,
 *         to_string?: array{
 *             auto?: scalar|null, // Default: false
 *             format?: scalar|null, // Default: null
 *             properties?: list<scalar|null>,
 *         },
 *         select_option?: array{
 *             placeholder?: scalar|null, // Default: "search"
 *             dir?: scalar|null, // Default: "ltr"
 *             delay?: scalar|null, // Default: 1000
 *             minimum_input_length?: scalar|null, // Default: 0
 *             maximum_input_length?: scalar|null, // Default: 0
 *             minimum_results_for_search?: scalar|null, // Default: 0
 *             maximum_selection_length?: scalar|null, // Default: 0
 *             minimum_selection_length?: scalar|null, // Default: 0
 *             multiple?: scalar|null, // Default: false
 *             width?: scalar|null, // Default: "resolve"
 *             scroll_after_select?: scalar|null, // Default: false
 *             language?: scalar|null, // Default: "auto"
 *             select_on_close?: scalar|null, // Default: false
 *             theme?: scalar|null, // Default: "default"
 *             amd_base?: scalar|null, // Default: "./"
 *             amd_language_base?: scalar|null, // Default: "./i18n/"
 *             cache?: scalar|null, // Default: false
 *             ...<mixed>
 *         },
 *         cdn?: array{
 *             auto?: scalar|null, // Default: false
 *             link?: scalar|null, // Default: null
 *             script?: scalar|null, // Default: null
 *             language?: scalar|null, // Default: null
 *             ...<mixed>
 *         },
 *         security?: array{
 *             public_access?: scalar|null, // Default: false
 *             voter?: scalar|null, // Default: "danilovl.select_autocompleter.voter.default"
 *             role?: list<scalar|null>,
 *             condition?: scalar|null, // Default: "and"
 *             ...<mixed>
 *         },
 *         route?: array{
 *             name?: scalar|null, // Default: "danilovl_select_autocomplete"
 *             parameters?: list<scalar|null>,
 *             extra?: list<scalar|null>,
 *             ...<mixed>
 *         },
 *     },
 ...
 *         name: scalar|null,
 *         class: scalar|null,
 *         id_property?: scalar|null,
 *         property?: scalar|null,
 *         property_search_type?: scalar|null,
 *         image?: scalar|null,
 *         image_result_width?: scalar|null,
 *         image_selection_width?: scalar|null,
 *         root_alias?: scalar|null,
 *         limit?: scalar|null,
 *         compound?: scalar|null, // Default: false
 *         multiple?: scalar|null, // Default: false
 *         manager?: scalar|null,
 *         search_simple?: list<scalar|null>,
 *         search_pattern?: list<scalar|null>,
 *         order_by?: list<scalar|null>,
 *         where?: list<scalar|null>,
 *         excluded_entity_id?: list<scalar|null>,
 *         to_string?: array{
 *             auto?: scalar|null, // Default: false
 *             format?: scalar|null, // Default: null
 *             properties?: list<scalar|null>,
 *         },
 *         widget?: scalar|null,
 *         base_template?: scalar|null,
 *         select_option?: array{
 *             placeholder?: scalar|null,
 *             delay?: scalar|null,
 *             dir?: scalar|null,
 *             minimum_input_length?: scalar|null,
 *             maximum_input_length?: scalar|null,
 *             minimum_results_for_search?: scalar|null,
 *             maximum_selection_length?: scalar|null,
 *             minimum_selection_length?: scalar|null,
 *             multiple?: scalar|null,
 *             width?: scalar|null,
 *             scroll_after_select?: scalar|null,
 *             language?: scalar|null,
 *             select_on_close?: scalar|null,
 *             theme?: scalar|null,
 *             amd_base?: scalar|null,
 *             amd_language_base?: scalar|null,
 *             cache?: scalar|null,
 *         },
 *         security?: array{
 *             public_access?: scalar|null,
 *             voter?: scalar|null,
 *             role?: list<scalar|null>,
 ...
 *             name?: scalar|null,
 *             parent_property?: scalar|null,
 *             parent_field?: scalar|null,
 *             many_to_many?: list<scalar|null>,
 *         }>,
 *         route?: array{
 *             name?: scalar|null,
 *             parameters?: list<scalar|null>,
 ...
 *     cache_adapter?: scalar|null, // Default: null
 *     kernel_controller_priority?: scalar|null, // Priority for the controller listener // Default: null
 *     kernel_response_priority?: scalar|null, // Priority for the response listener // Default: null
 * }
 * @psalm-type DanilovlHashidsConfig = array{
 *     salt?: scalar|null, // Default: ""
 *     min_hash_length?: int, // Default: 0
 *     alphabet?: scalar|null, // Default: "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890"
 *     enable_param_converter?: bool, // Default: false
 * }
