INSERT INTO `conversation_type` (`id`, `name`, `description`, `constant`, `created_at`, `update_at`)
VALUES (1, 'WORK', NULL, 'WORK', NOW(), NULL),
	   (2, 'GROUP', NULL, 'GROUP', NOW(), NULL);

INSERT INTO `event_type` (`id`, `color`, `registrable`, `name`, `description`, `constant`, `created_at`, `update_at`)
VALUES (1, '#3b91ad', 1, 'Consultation', NULL, 'CONSULTATION', NOW(), NULL),
	   (2, '#cab31c', 0, 'Personal calendar', NULL, 'PERSONAL', NOW(), NULL);

INSERT INTO `media_mime_type` (`id`, `name`, `extension`, `active`, `created_at`, `update_at`)
...
INSERT INTO `media_type` (`id`, `folder`, `name`, `description`, `constant`, `created_at`, `update_at`)
...
INSERT INTO `system_event_type` (`id`, `group`, `name`, `description`, `constant`, `created_at`, `update_at`)
...
INSERT INTO `work_status` (`id`, `color`, `name`, `description`, `constant`, `created_at`, `update_at`)
...
INSERT INTO `work_type` (`id`, `shortcut`, `name`, `description`, `created_at`, `update_at`)
VALUES (1, 'DT', 'Diploma thesis', NULL, NOW(), NULL),
	   (2, 'BT', 'Bachelor thesis', NULL, NOW(), NULL),
	   (3, 'Other', 'Other', NULL, NOW(), NULL);

INSERT INTO `conversation_message_status_type` (`id`, `name`, `description`, `constant`, `created_at`, `update_at`)
